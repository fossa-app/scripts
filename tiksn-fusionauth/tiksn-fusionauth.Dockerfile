...
ENV DATABASE_REMOTE="https://doltremoteapi.dolthub.com/tiksn/fusionauth"
ENV DATABASE_NAME=fusionauth
ENV DOLTHUB_USER="Tigran TIKSN Torosyan"
ENV DOLTHUB_EMAIL="personal@tiksn.com"
ENV DATA_DIR="/dolthub-dbs/tiksn/$DATABASE_NAME"
...
WORKDIR /dolthub-dbs/tiksn
CMD [ "dolt", "sql-server", "-l=trace", "--host=0.0.0.0", "--port=3306", "--user=fusionauth", "--password=fusionauth"]
